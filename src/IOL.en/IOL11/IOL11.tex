...
\sameinfo:
\bord{bed} `\bed',
\bord{butterfly} `\butterfly',
\bord{cat} `\cat',
\bord{cow} `\cow',
\bord{refrigerator} `\refrigerator',
\bord{spoon} `\spoon'.
\medskip \\
%
...
\bord{refrigerator} & `\refrigerator' & \low & \low & \high & \high\\
\bord{cow} & `\cow' & \low & \low & \high & \low\\
\bord{bed} & `\bed' & \high & \low & \low & \low\\
\bord{butterfly} & `\butterfly' & \low & \low & \low & \high\\
\bord{spoon} & `\spoon' & \low & \high & \high & \low\\
\bord{cat} & `\cat' & \low & \low & \low & \low\\ \hline
\end{tabular}}
