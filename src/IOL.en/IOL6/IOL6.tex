...
\newcommand \onor [1]{\bgroup\fontencoding{T1}\selectfont #1\egroup}
\newcommand \onob [1]{\bgroup\fontencoding{T1}\bfseries\selectfont #1\egroup}
\newcommand \trans [1]{\bgroup\fontencoding{T3}\selectfont\SetUnicodeOption{tipa}[#1]\egroup}
\newcommand \ipa [1]{\bgroup\fontencoding{T3}\bfseries\selectfont\SetUnicodeOption{tipa}#1\egroup}
\newcommand \chn [2]{\ipa{#1}$^{#2}$}
\newcommand \Ctx [1]{\bgroup\fontencoding{C00}\fontfamily{bsmi}\selectfont\SetUnicodeOption{cjkbg5}#1\egroup}
...
\dql2{\gap b ; knǫ\hspace{-6pt}́ttu spjǫ\hspace{-6pt}́r \gap c )} \\
\dql3{\gap d bitu seggi} \\
\dql4{\gap e þjóðkonungs ferðar,} \\
\dql5{þás ( \gap f hǫlða)} \\
\dql6{\gap g \gap h \gap i} \\
\dql7{(hǫ\hspace{-6pt}́r vas \gap j of \gap k )} \\
...
\dqr2{\gzp b{\textbf r\underline{ym}r} ; knǫ\hspace{-5pt}́ttu spjǫ\hspace{-5pt}́r \gzp c{gl\underline{ym}ja} )} \\
...
\dqr7{(hǫ\hspace{-5pt}́\underline r vas \gzp j{\textbf sǫngr} of \gzp k{\textbf sví\underline rum} )} \\
...
\end{tabular}
\item \bord{wahnawa} `\bananawd', \bord{drai} `\jourword'; \bord{wöli} `\piquemot', \bord{pulut} `\dormimot'.
\item \bord{i-bii} `\abeilles\ (\multitud {\abeimult})', \bord{tusi-hmitrötr} `\biblemot\ (\holytome\ \tomeword)'.
\end{assgts}

\solution \zoquesfx:
%
\begin{enumerate}
\item \ipa{-k2sm2} `\abovemot', \ipa{-kotoya} `\forparol', \ipa{-pit} \withword;
\item \ipa{-šeh} `\como, \cosi';
\item \ipa{-taPm} \renderpl;
\item \ipa{-tih} `\solo\ (\just, \rite)'.
\end{enumerate}
%
...
& \textsf{X}-\bord{(q)} && \textsf{V}-- & `\textsf{X} \Vhimself.' \\
& \textsf{X}-\bord{(q)} & \textsf{Y}-\bord{(r)mik} & \textsf{V}-\bord{si}-- & `\textsf{X} \textsf{V} \aYrender.' \\
\textsf{X}-\bord{up} & \textsf{Y}-\bord{(q)} && \textsf{V}-- & `\textsf{X} \textsf{V} \theYrend.' \\
\end{tabular}
\medskip \\
%
...
\item \endingin:
\begin{itemize}
\item \schemata: \bord{-u-tit} `2', \bord{-u-q} `3';
\item \schematr: \bord{-a-it} `2/3', \bord{-a-nga} `3/3', \bord{-a-atit} `3/2'.
\end{itemize}
\end{itemize}
%
\transref.
