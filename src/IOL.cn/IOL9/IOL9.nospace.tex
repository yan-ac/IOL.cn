...
\def \LMark {\quoted{\bfseries¯}}
\def \AMark {\quoted{\bfseries\ ́}}
\def \BMark {\quoted{\bfseries `}}
\def \CMark {\quoted{\bfseries ˇ}}
...
\tonmarks {{\textbf{\AMark}}, {\textbf{\BMark}} \et\ {\textbf{\CMark}}}.
%
\by{—\OKname}
...
\item \incompoN\lastonlo\ (\textbf{\BMark}).
\end{enumerate}
