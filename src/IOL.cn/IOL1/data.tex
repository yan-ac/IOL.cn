...
\newcommand \solution [1]{\section*{第\stepcounter {section}\toCmnNum{\thesection}\soluword}}
...
\def \basqmore #1#2#3#4{\begin{tabular}[t]{ll}
 #1 & \word{abenduaren lehenengo astelehena} \\
 #2 & \word{azaroaren hogeita bederatzigarrena, larunbata} \\
 #3 & \word{urtarrilaren bigarren astea} \\
 #4 & \word{otsailaren hirugarrena, astelehena} \\
\end{tabular}}
