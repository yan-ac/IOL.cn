...
\def \telepate{下面你可以找到一些脑部四个区域的活跃等级的数据, 取决于志愿者们所想的单词}
\def \telepatd{使用获得的数据, 研究人员能够成功地判断志愿者所想的单词}
\def \sameinfo{下面给出了志愿者们所想的另外六个单词的相同信息}
...
\def \lagahi{蚂蚁们}
\def \lagahino{他的蚂蚁们}
\def \alaalaga{\underline{蚂蚁}}
\def \munasubj{我的小学生的蚂蚁}
\def \murihi{小学生们}
\def \murihino #1{#1的小学生们}
\def \molohino #1{#1的群山}
\def \munasubn{我的女人们的猴子们}
\def \robhinehi{女人们}
\def \robhineno{他的女人}
\def \kontuhi{群石}
\def \damanaka{将暖和}
...
\def \nakudomoho{将远}
\def \munazina{正在爬山}
\def \munazinm{正在前往\underline{恶魔}}
\def \munazini{正在回房子}
\def \munazink{正在砍他们的山}
\def \munazinp{正在买我的蚂蚁们}
\def \munazine{正在吃我的猴子们}
\def \munazinf{将买\underline{恶魔}的房子}
\def \munazinl{将爬小学生的石头}
\def \munazinn{将切我的香蕉们}
\def \munazind{将吃女人的香蕉}
\def \munazinq{将回到女人们的小学生}
\def \munazinh{将去找\underline{猴子}}
\def \andoandoke{\underline{猴子}}
\def \demonkey{猴子}
\def \monkey #1{猴子}
\def \nime #1{房屋}
\def \cohoje #1{刀}
